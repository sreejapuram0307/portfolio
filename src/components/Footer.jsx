    ...
    <footer className="bg-gradient-to-br from-primary-900 to-primary-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-display font-bold mb-4">P. Sreeja</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/projects" className="text-primary-200 hover:text-white transition-colors">
                  Projects
                </Link>
              </li>
              <li>
                <Link to="/skills" className="text-primary-200 hover:text-white transition-colors">
                  Skills
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-primary-800 text-center text-sm text-primary-300">
          <p>&copy; {new Date().getFullYear()} P. Sreeja. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
